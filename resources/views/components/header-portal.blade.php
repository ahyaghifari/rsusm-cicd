<!-- TopNavBar -->
<header class="bg-white docked full-width top-0 z-50 border-b-4 border-primary flex justify-between p-5">
    <div
        ...
        <div class="text-headline-md font-headline-md font-bold text-primary">
            <span class="text-black">RUMAH SAKIT UMUM</span> <br>
            <span>SYIFA MEDIKA</span>
        </div>
    </div>
    <img src="{{ asset('img/sgg.png') }}" class="w-48 h-fit" alt="">
</header>
