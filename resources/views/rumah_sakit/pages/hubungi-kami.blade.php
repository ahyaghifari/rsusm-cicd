<div>
    ...
    <div class="w-10/12 mx-auto pb-20 mt-10">
        ...
        {{-- Operasional --}}
        @if($sosial_media->count() > 0)
        <div class="mb-16">
            <div class="flex items-center gap-3 mb-8">
                <div class="w-1 h-7 bg-tertiary rounded-full"></div>
                <h2 class="text-on-surface font-bold text-2xl">Sosial Media</h2>
                <span class="ml-1 bg-tertiary/10 text-tertiary text-xs font-semibold px-2.5 py-1 rounded-full">
                    {{ $sosial_media->count() }} sosial media
                </span>
            </div>
