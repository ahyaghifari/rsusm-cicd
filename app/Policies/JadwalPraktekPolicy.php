...
class JadwalPraktekPolicy
{
    ...
    {
        return $user->can('force_delete_jadwal::praktek');
    }
    ...
    {
        return $user->can('force_delete_any_jadwal::praktek');
    }
    ...
    {
        return $user->can('restore_jadwal::praktek');
    }
    ...
    {
        return $user->can('restore_any_jadwal::praktek');
    }
    ...
    {
        return $user->can('replicate_jadwal::praktek');
    }
    ...
    {
        return $user->can('reorder_jadwal::praktek');
    }
}
